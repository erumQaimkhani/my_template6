...
const Header: React.FC = () => {
  ...
  const toggleWishlist = (item: string) => {
    const updatedWishlist = wishlist.includes(item)
      ? wishlist.filter((wishlistItem) => wishlistItem !== item) // Remove item if already in wishlist
      : [...wishlist, item]; // Add item if it's not in wishlist

    setWishlist(updatedWishlist);

    // Persist the wishlist in localStorage
